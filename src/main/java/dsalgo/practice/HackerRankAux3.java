...
//        wordsVowels("a     u    b");
//        System.out.println(sieveOfEratosthenesCount(30));
...
//    print(*sorted(output_list),sep='\n')
    ...
    public static long sieveOfEratosthenesCount(int n) {
...
//        System.out.println();
    ...
    public static Set<Integer> sieveOfEratosthenesHashSet(int n) {
