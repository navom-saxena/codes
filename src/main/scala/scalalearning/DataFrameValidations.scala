...
object DataFrameValidations extends App {
  ...
  val t0: DataFrame = spark.read.option("header", "true").csv("file:///Users/navomsaxena/Downloads/Teradat.csv")
  val f0: DataFrame = spark.read.option("header", "true").csv("file:///Users/navomsaxena/Downloads/foundry.csv")
